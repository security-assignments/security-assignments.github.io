...
* [styles.sass]({{ "/templates/project/styles.sass" | relative_url }}) - main project Sass file, imports Bootstrap and variables.
* [_bootstrap-variables.sass]({{ "/templates/project/_bootstrap-variables.sass" | relative_url }}) - all of Bootstrap variables, override them here.
...
Sass, JS, and all other assets are located at [assets]({{ "/assets" | relative_url }}).
...
See also this [example manifest.js]({{ "/test/dummy_node_mincer/manifest.js" | relative_url }}) for mincer.
...
[`assets/javascripts/bootstrap.js`]({{ "/assets/javascripts/bootstrap.js" | relative_url }}) contains all of Bootstrap JavaScript,
concatenated in the [correct order]({{ "/assets/javascripts/bootstrap-sprockets.js" | relative_url }}).
...
Always refer to [CHANGELOG.md]({{ "/CHANGELOG.md" | relative_url }}) when upgrading.
